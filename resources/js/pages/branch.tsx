...
export default function BranchPage({ branch, listings = [] }: { branch: Branch; listings?: Listing[] }) {
    return (
        <PublicLayout title={branch.tradingName} tone="light">
            ...
            <section className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8">
                <Link href={route('branches')} className="inline-flex items-center gap-2 text-sm text-neutral-500 transition-colors hover:text-marine">
            ...
            <section className="mx-auto max-w-7xl px-4 py-10 pb-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-10">
                    <PropertyGrid listings={listings} emptyMessage="This branch has no listings on the market right now." />
                </div>
            </section>
        </PublicLayout>
    );
